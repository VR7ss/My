...
function openVideoModal(videoSrc, videoTitle) {
  ...
  // Determine file type and set appropriate source
  if (videoSrc.endsWith('.mov') || videoSrc.endsWith('.MOV')) {
    videoSource.src = '';
    videoSourceMov.src = videoSrc;
  } else {
