   ...
   async function fetchExploitStatus() {
       ...
       try {
           ...
           exploits.forEach(function(exploit) {
               var exploitName = exploit.title;
               var appCard = document.querySelector('.app-card[data-exploit-name="' + exploitName + '"]');
               if (appCard) {
                   // Update badge status
                   var appBadge = appCard.querySelector('.app-badge');
                   if (appBadge) {
                   ...
                   // Update version tag
                   var versionTag = appCard.querySelector('.version-tag');
